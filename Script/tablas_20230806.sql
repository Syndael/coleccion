...
-- Volcando estructura para disparador coleccion.SET_CODIGO_BASE_ON_INSERT
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `SET_CODIGO_BASE_ON_INSERT` BEFORE INSERT ON `BASE` FOR EACH ROW BEGIN
...
-- Volcando estructura para disparador coleccion.SET_CODIGO_BASE_ON_UPDATE
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `SET_CODIGO_BASE_ON_UPDATE` BEFORE UPDATE ON `BASE` FOR EACH ROW BEGIN
	SET NEW.CODIGO = REGEXP_REPLACE(
		REPLACE(
			REPLACE(
				REPLACE(
...
-- Volcando estructura para disparador coleccion.SET_CODIGO_COLECCION_ON_INSERT
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `SET_CODIGO_COLECCION_ON_INSERT` BEFORE INSERT ON `COLECCION` FOR EACH ROW BEGIN
...
-- Volcando estructura para disparador coleccion.SET_CODIGO_COLECCION_ON_UPDATE
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `SET_CODIGO_COLECCION_ON_UPDATE` BEFORE UPDATE ON `COLECCION` FOR EACH ROW BEGIN
  DECLARE plataforma_corto VARCHAR(255);
  DECLARE plataforma_nombre VARCHAR(255);
  DECLARE juego_codigo VARCHAR(255);
  DECLARE fecha_ins_str VARCHAR(255);
